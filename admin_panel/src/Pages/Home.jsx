        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {statCards.map((card, idx) => (
            <div key={idx} className="relative group overflow-hidden bg-slate-800/50 border border-slate-700 p-6 rounded-2xl hover:border-slate-500 transition-all duration-300 shadow-xl">
              <div className={`absolute top-0 right-0 w-24 h-24 bg-linear-to-br ${card.color} opacity-10 blur-2xl group-hover:opacity-20 transition-opacity`}></div>
              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-xl bg-linear-to-br ${card.color} text-black shadow-lg shadow-black/20`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 h-full shadow-2xl">
              ...
              <div className="mt-8 p-6 bg-linear-to-r from-yellow-500/10 to-transparent border border-yellow-500/20 rounded-2xl">
